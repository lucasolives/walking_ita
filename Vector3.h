...
public:
	 ...
	 */
	Vector3<V>(V multiplier, const Vector3<V>& other){
		x = multiplier*other.x;
		y = multiplier*other.y;
		z = multiplier*other.z;
	}
...
//	}
	 ...
	 */
	V abs() const {
		return (V) sqrtf(double((x * x) + (y * y) + (z * z)));
	}
